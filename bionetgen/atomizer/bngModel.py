        ...
        for arule in self.arules.values():
            ...
            if arule.isRate:
                ...
                if arule.Id in self.parameters:
                    ...
                    # Note: We pop the parameter here since it's an assignment rule.
                    # The SBML spec states assignment rules overwrite initial parameter values.
                    # Therefore, any initial value given is irrelevant.
