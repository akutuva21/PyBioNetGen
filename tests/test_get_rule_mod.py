...
def test_get_rule_mod():
    ...
    xml_totalrate = {
        "@name": "test_rule",
        "ListOfOperations": {},
        "RateLaw": {"@type": "Function", "@totalrate": 1, "@id": "rule1", "@name": "rate1"}
    }
    ...
    xml_move = {
        ...
        "ListOfOperations": {
            "ChangeCompartment": [
                {"@moveConnected": "1", "@id": "m1", "@source": "s1", "@destination": "d1", "@flipOrientation": "0"},
                {"@moveConnected": "1", "@id": "m2", "@source": "s2", "@destination": "d2", "@flipOrientation": "1"}
            ]
        }
    }
