...
def test_name2uniprot_with_organism():
    ...
    with patch('urllib.request.urlopen') as mock_urlopen:
        ...
        mock_response.read.return_value = b'entry name\tid\nEGF_HUMAN\tP01133\nEGF_MOUSE\tP01132\n'.decode('utf-8')
...
def test_name2uniprot_fallback_no_organism():
    ...
    with patch('urllib.request.urlopen') as mock_urlopen:
        ...
        mock_response_2.read.return_value = b'entry name\tid\nEGF2_HUMAN\tP01133\n'.decode('utf-8')
...
def test_name2uniprot_http_error_with_organism():
    ...
    with patch('urllib.request.urlopen') as mock_urlopen:
        mock_urlopen.side_effect = HTTPError(url='', code=500, msg='Internal Server Error', hdrs={}, fp=None)
